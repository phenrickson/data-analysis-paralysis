...
![](/Users/Phil/Documents/projects/data-analysis-paralysis/images/predicting_games.png){width=45%} ![](/Users/Phil/Documents/projects/data-analysis-paralysis/images/outcome_coefs.png){width=45%}
...
![](/Users/Phil/Documents/projects/data-analysis-paralysis/images/averages_and_usersrated.png){width=45%} ![](/Users/Phil/Documents/projects/data-analysis-paralysis/images/hotness_adjusted.png){width=45%}
...
3. [**Predicting User Collections, or How to Create an Artificial Shut Up and Sit Down**]()

![](/Users/Phil/Documents/projects/data-analysis-paralysis/images/user_separation.png){width=45%} ![](/Users/Phil/Documents/projects/data-analysis-paralysis/images/user_predictions_table.png){width=45%}

"What upcoming games should I check out?"

Rather than trying to predict how the boardgamegeek community will rate a game, I train models at the individual user level to predict whether someone will be likely to add an upcoming game to their collection. This started as a project to [train a model to identify games for myself](https://phenrickson.github.io/bgg_reports/mrbananagrabber_2020.html), but then I realized that this could be extended to anyone with a boardgamegeek account and a decent number of games in their collection. 

This analysis can be run for anyone with a BGG account, so I've run it for a few prominent reviewers to see what upcoming games they're most likely to be interested in:

[Watch It Played](https://phenrickson.github.io/bgg_reports/Watch_It_Played_2020.html)

[Mark Bigney (So Very Wrong About Games)](https://phenrickson.github.io/bgg_reports/Gyges_2020.html)

[Richard Ham (rahdo)](https://phenrickson.github.io/bgg_reports/rahdo_2020.html)

[Quinns (Shut Up and Sit Down, though his data is a bit out of date)](https://phenrickson.github.io/bgg_reports/Quinns_2020.html)

[Zee Garcia (The Dice Tower)](https://phenrickson.github.io/bgg_reports/ZeeGarcia_2020.html)

[me](https://phenrickson.github.io/bgg_reports/mrbananagrabber_2020.html)

[my brother](https://phenrickson.github.io/bgg_reports/GOBBluth89_2020.html)
